...
export default function About() {
  ...
  <div className="pt-12 px-2 flex flex-row items-center justify-center min-h-screen gap-8">
        ...
        <div className="flex flex-col items-start">
          <h1 className="text-3xl font-bold mb-4">About <span className="text-primary">Joseph</span></h1>
          <div className="bg-overlay dark:bg-overlaydark text-text dark:text-textdark p-6 rounded-lg shadow-lg">
